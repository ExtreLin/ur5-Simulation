...
void CURControl::addCollision()
{
    ...
    collision_object_publisher.publish(collision_object1);
    collision_object_publisher.publish(collision_object2);
    collision_object_publisher.publish(collision_object3);
...
void CURControl::planningPose(const Eigen::VectorXf& nextPose)
{
        ...
        Specified_pose.orientation.w =  nextPose[3];
        Specified_pose.orientation.x =  nextPose[4];
        Specified_pose.orientation.y =  nextPose[5];
        Specified_pose.orientation.z =  nextPose[6];
